...
export const networkConfigs: Record<string, BaseNetworkConfig> = {
  [ChainId.kovan]: {
    name: 'Kovan',
    // publicJsonRPCUrl: ['https://eth-kovan.alchemyapi.io/v2/demo', 'https://kovan.poa.network', 'https://eth-kovan.alchemyapi.io/v2/${ALCHEMY_KEY}'],
    publicJsonRPCUrl: ['https://eth-kovan.alchemyapi.io/v2/Lm0kAEfpbLmeuJGvtnCQ_nZa3OLT8dR3'],
